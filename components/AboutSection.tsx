...
const AboutSection = () => {
  ...
  return (
    <section ref={ref} className="py-32 md:py-40 bg-black" id="about">
      <SectionContainer>
        {/* Section Header */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              My approach combines technical excellence with creative problem-solving. Whether it&apos;s building scalable backend systems or crafting intuitive user interfaces, I focus on delivering solutions that exceed expectations.
            </p>
          ...
          >
            <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/5 border border-blue-500/20 rounded-2xl p-8 space-y-8 backdrop-blur-sm">
              
              <div className="group hover:bg-blue-500/5 p-6 rounded-xl transition-all duration-300 cursor-default">
              ...
              <div className="group hover:bg-cyan-500/5 p-6 rounded-xl transition-all duration-300 cursor-default">
                <div className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-teal-400">
                  50+
                </div>
              ...
              <div className="group hover:bg-emerald-500/5 p-6 rounded-xl transition-all duration-300 cursor-default">
