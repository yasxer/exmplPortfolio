...
      {/* 💡 التعديل 1: تم إزالة px-72 من عنصر section الخارجي. 
            SectionContainer هو الذي سيعالج الـ padding الجانبي الآن. */}
      <SectionContainer>
        {/* Section Header */}
...
        {/* 💡 التعديل 2: تم تغيير lg:gap-20 إلى lg:gap-16 لتقليل التباعد قليلاً على الشاشات الكبيرة */}
